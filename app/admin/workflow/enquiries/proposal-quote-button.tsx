...
export function ProposalQuoteButton({
  enquiryId,
  enquiryCode,
  productNames,
  hasPhone,
  ...
  function handleSubmit(formData: FormData) {
    ...
    startTransition(async () => {
      try {
        ...
        setSuccess("Proposal / Quotation sent")
        setIsOpen(false)
            ...
            <form action={handleSubmit} className="grid gap-5 p-6">
              <div>
                ...
                <input
                  ...
                  placeholder="Example: Premium bottles for employee gifting"
                  required
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  placeholder="Example: Please review the quotation and share your confirmation. We can proceed with logo placement and final delivery timeline after approval."
